  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        // Reminders Cubit - User care reminders
        BlocProvider<RemindersCubit>(create: (context) => RemindersCubit()),
